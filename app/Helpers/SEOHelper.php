...
class SEOHelper
{
    ...
    public static function generateKeywords($keywords = [])
    {
        $defaultKeywords = [
            ...
            'harga vixion',
            'harga vixion jogja',
            'harga vixion jogja 2026',
            'harga otr vixion jogja',
            'vixion mataram sakti',
            'dealer vixion jogja',
            'beli vixion jogja',
            'kredit vixion jogja',
            'promo vixion jogja',
            ...
            'review vixion jogja',
            'warna vixion 2026',
            'berapa harga vixion jogja',
            'vixion ready stock jogja',
            
            // ========================================
            // TIER 0E: XMAX ULTRA PRIORITY
            // ========================================
            'xmax',
            'yamaha xmax',
            'xmax jogja',
            ...
            'xmax sleman',
            'xmax bantul',
            'spesifikasi xmax 2026',
            'review xmax jogja',
            'warna xmax 2026',
            'berapa harga xmax jogja',
            'xmax ready stock jogja',
            
            // ========================================
            // TIER 0F: BRAND NAME - ULTRA CRITICAL
            // ========================================
            ...
            // ========================================
            // TIER 36: WONOSARI & GUNUNGKIDUL KEYWORDS
            // ========================================
            // Wonosari Primary
            'dealer yamaha wonosari',
            'yamaha wonosari',
            ...
            'promo yamaha wonosari',
            'showroom yamaha wonosari',
            'dealer resmi yamaha wonosari',
            'yamaha mataram sakti wonosari',
            'beli motor yamaha wonosari',
            'nmax wonosari',
            'aerox wonosari',
            'r15 wonosari',
            ...
            'dealer yamaha gunungkidul',
            'yamaha gunungkidul',
            'motor yamaha gunungkidul',
            'harga motor yamaha gunungkidul',
            'kredit motor yamaha gunungkidul',
            'promo yamaha gunungkidul',
            'showroom yamaha gunungkidul',
            'dealer resmi yamaha gunungkidul',
            'beli motor yamaha gunungkidul',
            
            // All Kecamatan in Gunungkidul
            'dealer yamaha playen',
            'dealer yamaha patuk',
            'dealer yamaha paliyan',
            'dealer yamaha panggang',
            'dealer yamaha tepus',
            'dealer yamaha semanu',
            'dealer yamaha karangmojo',
            'dealer yamaha ponjong',
            ...
            'dealer yamaha ngawen',
            'dealer yamaha gedangsari',
            'dealer yamaha saptosari',
            'dealer yamaha girisubo',
            'dealer yamaha tanjungsari',
            'dealer yamaha purwosari',
            'motor yamaha playen',
            'motor yamaha patuk',
            'motor yamaha paliyan',
            'motor yamaha panggang',
            'motor yamaha tepus',
            'motor yamaha semanu',
            'motor yamaha karangmojo',
            'motor yamaha ponjong',
            'motor yamaha rongkop',
            'motor yamaha semin',
            'motor yamaha nglipar',
            'motor yamaha ngawen',
            'motor yamaha gedangsari',
            'motor yamaha saptosari',
            'motor yamaha girisubo',
            'motor yamaha tanjungsari',
            'motor yamaha purwosari',
            
            // All Kecamatan in Bantul
            'dealer yamaha sewon',
            'dealer yamaha kasihan',
            'dealer yamaha pandak',
            'dealer yamaha pajangan',
            'dealer yamaha sedayu',
            'dealer yamaha sanden',
            'dealer yamaha kretek',
            'dealer yamaha pundong',
            'dealer yamaha bambanglipuro',
            ...
            'dealer yamaha pleret',
            'dealer yamaha piyungan',
            'dealer yamaha srandakan',
            'motor yamaha sewon',
            'motor yamaha kasihan',
            'motor yamaha pandak',
            'motor yamaha pajangan',
            'motor yamaha sedayu',
            'motor yamaha sanden',
            'motor yamaha kretek',
            'motor yamaha pundong',
            'motor yamaha bambanglipuro',
            'motor yamaha jetis bantul',
            'motor yamaha imogiri',
            'motor yamaha dlingo',
            'motor yamaha banguntapan',
            'motor yamaha pleret',
            'motor yamaha piyungan',
            'motor yamaha srandakan',
            
            // All Kecamatan in Sleman
            'dealer yamaha depok',
            'dealer yamaha mlati',
            'dealer yamaha gamping',
            'dealer yamaha godean',
            ...
            'dealer yamaha seyegan',
            'dealer yamaha ngaglik',
            'dealer yamaha ngemplak',
            'dealer yamaha kalasan',
            'dealer yamaha berbah',
            'dealer yamaha prambanan',
            'dealer yamaha cangkringan',
            'dealer yamaha turi',
            'dealer yamaha pakem',
            ...
            'motor yamaha gamping',
            'motor yamaha godean',
            'motor yamaha moyudan',
            'motor yamaha minggir',
            'motor yamaha seyegan',
            'motor yamaha ngaglik',
            'motor yamaha ngemplak',
            'motor yamaha kalasan',
            'motor yamaha berbah',
            'motor yamaha prambanan',
            'motor yamaha cangkringan',
            'motor yamaha turi',
            'motor yamaha pakem',
            'motor yamaha tempel',
            
            // All Kecamatan in Kota Yogyakarta
            'dealer yamaha gondokusuman',
            'dealer yamaha jetis jogja',
            'dealer yamaha tegalrejo',
            'dealer yamaha umbulharjo',
            'dealer yamaha kotagede',
            'dealer yamaha mergangsan',
            ...
            'dealer yamaha wirobrajan',
            'motor yamaha gondokusuman',
            'motor yamaha jetis jogja',
            'motor yamaha tegalrejo',
            'motor yamaha umbulharjo',
            'motor yamaha kotagede',
            'motor yamaha mergangsan',
            'motor yamaha mantrijeron',
            'motor yamaha kraton',
            'motor yamaha gondomanan',
            'motor yamaha pakualaman',
            'motor yamaha danurejan',
            'motor yamaha gedongtengen',
            'motor yamaha ngampilan',
            'motor yamaha wirobrajan',
            
            // All Kecamatan in Kulon Progo (Complete)
            'dealer yamaha temon',
            'dealer yamaha panjatan',
            'dealer yamaha galur',
            'dealer yamaha lendah',
            ...
            'dealer yamaha samigaluh',
            'motor yamaha temon',
            'motor yamaha panjatan',
            'motor yamaha galur',
            'motor yamaha lendah',
            'motor yamaha sentolo',
            'motor yamaha pengasih',
            'motor yamaha kokap',
            'motor yamaha girimulyo',
            'motor yamaha nanggulan',
            'motor yamaha kalibawang',
            'motor yamaha samigaluh',
            
            // Long-tail Location Keywords
            'dealer yamaha terdekat dari wonosari',
            'dealer yamaha terdekat dari gunungkidul',
            'jarak dealer yamaha dari wonosari',
            'alamat dealer yamaha wonosari',
            'nomor telepon dealer yamaha wonosari',
            'wa dealer yamaha wonosari',
            'harga nmax wonosari',
            'harga aerox wonosari',
            'harga r15 wonosari',
            'kredit motor yamaha wonosari',
            'dp murah yamaha wonosari',
            'cicilan ringan yamaha wonosari',
            'promo yamaha wonosari 2026',
            'diskon yamaha wonosari',
            'service yamaha wonosari',
            'bengkel yamaha wonosari',
            'spare part yamaha wonosari',
            
            // ========================================
            // TIER 10: JAWA TENGAH - PURWOREJO
            // ========================================
            'dealer yamaha purworejo',
            'yamaha purworejo',
            'motor yamaha purworejo',
            'harga motor yamaha purworejo',
            'kredit motor yamaha purworejo',
            'promo yamaha purworejo',
            'nmax purworejo',
            'aerox purworejo',
            'r15 purworejo',
            'vixion purworejo',
            'xmax purworejo',
            'harga nmax purworejo',
            'harga aerox purworejo',
            'harga r15 purworejo',
            'harga vixion purworejo',
            'harga xmax purworejo',
            'kredit nmax purworejo',
            'kredit aerox purworejo',
            'dp 0 yamaha purworejo',
            'cicilan ringan yamaha purworejo',
            'showroom yamaha purworejo',
            'dealer resmi yamaha purworejo',
            'service yamaha purworejo',
            'spare part yamaha purworejo',
            'promo dp murah yamaha purworejo',
            'harga otr yamaha purworejo',
            
            // ========================================
            // TIER 11: JAWA TENGAH - MAGELANG
            // ========================================
            'dealer yamaha magelang',
            'yamaha magelang',
            'motor yamaha magelang',
            'harga motor yamaha magelang',
            'kredit motor yamaha magelang',
            'promo yamaha magelang',
            'nmax magelang',
            'aerox magelang',
            'r15 magelang',
            'vixion magelang',
            'xmax magelang',
            'harga nmax magelang',
            'harga aerox magelang',
            'harga r15 magelang',
            'harga vixion magelang',
            'harga xmax magelang',
            'kredit nmax magelang',
            'kredit aerox magelang',
            'dp 0 yamaha magelang',
            'cicilan ringan yamaha magelang',
            'showroom yamaha magelang',
            'dealer resmi yamaha magelang',
            'service yamaha magelang',
            'spare part yamaha magelang',
            'promo dp murah yamaha magelang',
            'harga otr yamaha magelang',
            
            // ========================================
            // TIER 12: JAWA TENGAH - KLATEN
            // ========================================
            'dealer yamaha klaten',
            'yamaha klaten',
            'motor yamaha klaten',
            'harga motor yamaha klaten',
            ...
            'kredit aerox klaten',
            'dp 0 yamaha klaten',
            'cicilan ringan yamaha klaten',
            'showroom yamaha klaten',
            'dealer resmi yamaha klaten',
            'service yamaha klaten',
            'spare part yamaha klaten',
            'promo dp murah yamaha klaten',
            'harga otr yamaha klaten'
        ];
            ...
            case 'LocalBusiness':
                return array_merge([
                    ...
                    'areaServed' => [
                        ...
                        // Gunungkidul
                        ['@type' => 'City', 'name' => 'Wonosari'],
                        ['@type' => 'City', 'name' => 'Playen'],
                        ['@type' => 'City', 'name' => 'Patuk'],
                        ['@type' => 'City', 'name' => 'Paliyan'],
                        ['@type' => 'City', 'name' => 'Panggang'],
                        ['@type' => 'City', 'name' => 'Tepus'],
                        ['@type' => 'City', 'name' => 'Semanu'],
                        ['@type' => 'City', 'name' => 'Karangmojo'],
                        ['@type' => 'City', 'name' => 'Ponjong'],
                        ['@type' => 'City', 'name' => 'Rongkop'],
                        ['@type' => 'City', 'name' => 'Semin'],
                        ['@type' => 'City', 'name' => 'Nglipar'],
                        ['@type' => 'City', 'name' => 'Ngawen'],
                        ['@type' => 'City', 'name' => 'Gedangsari'],
                        ['@type' => 'City', 'name' => 'Saptosari'],
                        ['@type' => 'City', 'name' => 'Girisubo'],
                        ['@type' => 'City', 'name' => 'Tanjungsari'],
                        ['@type' => 'City', 'name' => 'Purwosari'],
                        // Bantul
                        ['@type' => 'City', 'name' => 'Bantul'],
                        ['@type' => 'City', 'name' => 'Sewon'],
                        ['@type' => 'City', 'name' => 'Kasihan'],
                        ['@type' => 'City', 'name' => 'Pandak'],
                        ['@type' => 'City', 'name' => 'Pajangan'],
                        ['@type' => 'City', 'name' => 'Sedayu'],
                        ['@type' => 'City', 'name' => 'Sanden'],
                        ['@type' => 'City', 'name' => 'Kretek'],
                        ['@type' => 'City', 'name' => 'Pundong'],
                        ['@type' => 'City', 'name' => 'Bambanglipuro'],
                        ['@type' => 'City', 'name' => 'Jetis Bantul'],
                        ['@type' => 'City', 'name' => 'Imogiri'],
                        ['@type' => 'City', 'name' => 'Dlingo'],
                        ['@type' => 'City', 'name' => 'Banguntapan'],
                        ['@type' => 'City', 'name' => 'Pleret'],
                        ['@type' => 'City', 'name' => 'Piyungan'],
                        ['@type' => 'City', 'name' => 'Srandakan'],
                        // Sleman
                        ['@type' => 'City', 'name' => 'Sleman'],
                        ['@type' => 'City', 'name' => 'Depok'],
                        ['@type' => 'City', 'name' => 'Mlati'],
                        ['@type' => 'City', 'name' => 'Gamping'],
                        ['@type' => 'City', 'name' => 'Godean'],
                        ['@type' => 'City', 'name' => 'Moyudan'],
                        ['@type' => 'City', 'name' => 'Minggir'],
                        ['@type' => 'City', 'name' => 'Seyegan'],
                        ['@type' => 'City', 'name' => 'Ngaglik'],
                        ['@type' => 'City', 'name' => 'Ngemplak'],
                        ['@type' => 'City', 'name' => 'Kalasan'],
                        ['@type' => 'City', 'name' => 'Berbah'],
                        ['@type' => 'City', 'name' => 'Prambanan'],
                        ['@type' => 'City', 'name' => 'Cangkringan'],
                        ['@type' => 'City', 'name' => 'Turi'],
                        ['@type' => 'City', 'name' => 'Pakem'],
                        ['@type' => 'City', 'name' => 'Tempel'],
                        // Kota Yogyakarta
                        ['@type' => 'City', 'name' => 'Gondokusuman'],
                        ['@type' => 'City', 'name' => 'Jetis Jogja'],
                        ['@type' => 'City', 'name' => 'Tegalrejo'],
                        ['@type' => 'City', 'name' => 'Umbulharjo'],
                        ['@type' => 'City', 'name' => 'Kotagede'],
                        ['@type' => 'City', 'name' => 'Mergangsan'],
                        ['@type' => 'City', 'name' => 'Mantrijeron'],
                        ['@type' => 'City', 'name' => 'Kraton'],
                        ['@type' => 'City', 'name' => 'Gondomanan'],
                        ['@type' => 'City', 'name' => 'Pakualaman'],
                        ['@type' => 'City', 'name' => 'Danurejan'],
                        ['@type' => 'City', 'name' => 'Gedongtengen'],
                        ['@type' => 'City', 'name' => 'Ngampilan'],
                        ['@type' => 'City', 'name' => 'Wirobrajan'],
