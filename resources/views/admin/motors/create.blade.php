...
@section('page-description', 'Tambahkan motor Yamaha ke dalam sistem')
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-plus me-2"></i>Form Tambah Motor
                </h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('price_otr') is-invalid @enderror" 
                                   id="price_otr" name="price_otr" value="{{ old('price_otr') }}" required>
                            @error('price_otr')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <input type="text" class="form-control" name="specifications[jumlah_silinder]" 
                                               ...
                                               value="{{ old('specifications.jumlah_silinder') }}">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <input type="text" class="form-control" name="specifications[sistem_starter]" 
                                               ...
                                               value="{{ old('specifications.sistem_starter') }}">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <input type="text" class="form-control" name="specifications[sistem_bahan_bakar]" 
                                               ...
                                               value="{{ old('specifications.sistem_bahan_bakar') }}">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                        <input type="text" class="form-control" name="specifications[tipe_kopling]" 
                                               ...
                                               value="{{ old('specifications.tipe_kopling') }}">
                                    </div>
                                    <div class="col-md-6 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        <input type="text" class="form-control" name="specifications[jarak_terendah_tanah]" 
                                               ...
                                               value="{{ old('specifications.jarak_terendah_tanah') }}">
                                    </div>
                                    <div class="col-md-6 mb-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <small class="text-muted">
                    ...
                    • Nama motor: TMAX, XMAX, NMAX, dll<br>
                    • Model: versi lengkap motor<br>
                    • Harga dalam Rupiah tanpa titik<br>
                    • Gambar maksimal 2MB<br>
                    • Motor unggulan akan tampil di carousel homepage<br>
                    • Spesifikasi bersifat opsional
                </small>
            </div>
        </div>
    </div>
