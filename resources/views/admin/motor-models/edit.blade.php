...
@section('title', 'Edit Model - ' . $model->full_name)
@section('page-title', 'Edit Model')
@section('page-description', 'Edit model ' . $model->full_name)
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.motors.models.update', [$motor, $model]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsi singkat tentang model ini">{{ old('description', $model->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price_otr') is-invalid @enderror" 
                                           id="price_otr" name="price_otr" value="{{ old('price_otr', $model->price_otr) }}">
                                    @error('price_otr')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price_dp') is-invalid @enderror" 
                                           id="price_dp" name="price_dp" value="{{ old('price_dp', $model->price_dp) }}">
                                    @error('price_dp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price_installment') is-invalid @enderror" 
                                           id="price_installment" name="price_installment" value="{{ old('price_installment', $model->price_installment) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="image" class="form-label">
                                    {{ $model->image ? 'Ganti Gambar' : 'Upload Gambar' }}
                                </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" 
                                       value="1" {{ old('is_featured', $model->is_featured) ? 'checked' : '' }}>
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                @else
                    <a href="{{ route('admin.motors.models.variants.create', [$motor, $model]) }}" 
